...
public class FootballTeam {
     ...
     */
    public void setNameTeam(@NotNull String nameTeam) {
     ...
     * @return rkis2.Goalkeeper in football team
     */
     ...
     * @param goalkeeper rkis2.Goalkeeper in football team
     */
    public void setGoalkeeper(@NotNull Goalkeeper goalkeeper) {
     ...
     */
    public void setFielder(@NotNull Fielder fielder) {
     ...
     * @param fielder The forward in football team
     */
    public FootballTeam(@NotNull String nameTeam, int countPeopleInTeam, @NotNull Goalkeeper goalkeeper, @NotNull Fielder fielder) {
        this.nameTeam = nameTeam;
        this.goalkeeper = goalkeeper;
        this.fielder = fielder;
        if (countPeopleInTeam > 1 && countPeopleInTeam <= 12) {
